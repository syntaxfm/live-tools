	...
	{#if isAdmin}
		<header class="app-header">
			<nav class="tabs" aria-label="Primary">
				<a class:is-active={isAdminRoute} class="tab" href={resolve('/admin')}>Live Show</a>
				...
				<a class:is-active={isAdminShowsRoute} class="tab" href={resolve('/admin/shows')}
					>All Shows</a
				>
				<a class:is-active={isAdminShowsRoute} class="tab" href={resolve('/admin/users')}>Users</a>
